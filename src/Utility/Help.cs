...
namespace DiffClient.Utility
{
    ...
    /// <summary>
    /// stole from https://www.pietschsoft.com/post/2009/01/26/csharp-flash-window-in-taskbar-via-win32-flashwindowex
    /// </summary>
    public static class FlashWindow
    {
        ...
        public static bool Flash()
        {
            ...
            if (Win2000OrLater)
            {
                FLASHWINFO fi = Create_FLASHWINFO(Process.GetCurrentProcess().MainWindowHandle, FLASHW_ALL | FLASHW_TIMERNOFG, uint.MaxValue, 0);
